...
export enum MethodIds {
   ...
   ISupportInfoType_DocumentationFiles_DocumentFileId_Open = 'i=36',
   ISupportInfoType_DocumentationFiles_DocumentFileId_Close = 'i=39',
   ISupportInfoType_DocumentationFiles_DocumentFileId_Read = 'i=63',
   ISupportInfoType_DocumentationFiles_DocumentFileId_Write = 'i=66',
   ISupportInfoType_DocumentationFiles_DocumentFileId_GetPosition = 'i=68',
   ISupportInfoType_DocumentationFiles_DocumentFileId_SetPosition = 'i=71',
...
export enum ObjectTypeIds {
   ...
   BaseLifetimeIndicationType = 'i=473',
   TimeIndicationType = 'i=474',
   NumberOfPartsIndicationType = 'i=475',
   NumberOfUsagesIndicationType = 'i=476',
   LengthIndicationType = 'i=477',
   DiameterIndicationType = 'i=478',
   SubstanceVolumeIndicationType = 'i=479',
   FunctionalGroupType = 'i=1005',
   ProtocolType = 'i=1006',
   IOperationCounterType = 'i=480',
   NetworkType = 'i=6247',
...
export enum VariableIds {
   DeviceHealthEnumeration_EnumStrings = 'i=6450',
   UpdateBehavior_OptionSetValues = 'i=388'
}

export enum VariableTypeIds {
   LifetimeVariableType = 'i=468',
